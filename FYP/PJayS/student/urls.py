...
from .views import register_student, delete_student_page, update_student_page, edit_student, update_student_kumpulan_page, register_student_kumpulan_page, help_page
